...
import com.example.pawmeal.databinding.VistaComidaBinding
...
class VistaComida : AppCompatActivity() {
    ...
    private lateinit var binding: VistaComidaBinding
    // iniciar firebase
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = VistaComidaBinding.inflate(layoutInflater)
